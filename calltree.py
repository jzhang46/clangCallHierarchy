...
if __name__ == "__main__":
    ...
    # optional args
    optional.add_argument('-c', '--command', action='store', default='./input_project_build_cmd.txt', dest='buildcommand_file', help='a file path contaning the commandline for building the project, default uses ./input_project_build_cmd.txt.')
    optional.add_argument('-f', '--inputfile', action='store', default='./input_functions.txt', dest='input_file', help='an txt file containing target functions, default uses ./input_functions.txt.')
